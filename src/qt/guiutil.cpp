...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "SpiderByte.lnk";
}
...
{
    return GetAutostartDir() / "SpiderByte.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("SpiderByte-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  SpiderByte-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("SpiderByte-Qt"));
