...
const string strMessageMagic = "SpiderByte Signed Message:\n";
                        ...
                        bool* pfMissingInputs)
{
    ...
    // by Simone, 2026-03-05: we stop this check, we need to start to accept non-standard TX in mempool
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in SpiderByte
    bool fStrictPayToScriptHash = true; // Always active in SpiderByte
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SpiderByte", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "version")
    {
        ...
        if (!vRecv.empty())
        {
          ...
          int iSubVerSpb = pfrom->strSubVer.find("SpiderByte");			// By Simone: SpiderByte re-brand: start to accept these as well
